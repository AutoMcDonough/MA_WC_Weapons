...
{ // Don't edit above this line
    partial class Weapons
    {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        Color = Color(red: 3, green: 2f, blue: 1f, alpha: 1),
		...
		private AmmoDef MA_Gatling_Old => new AmmoDef //meatball, blister
        {
          
                AmmoMagazine = "NATO_25x184mm",
                AmmoRound = "MA_GatlingAmmo_Old",
                HybridRound = false, //AmmoMagazine based weapon with energy cost
                EnergyCost = 0.00000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
                BaseDamage = 150f,
                Mass = 1f, // in kilograms
        ...
        private AmmoDef MA_Ion_1 => new AmmoDef //gladius and EMP ion
        {
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                AreaEffectDamage = 20f, // 0 = use spillover from BaseDamage, otherwise use this value.
