...
{ // Don't edit above this line
    partial class Weapons
    {
        ...
        private AmmoDef MA_Ion_1 => new AmmoDef //gladius ion
        {
            AmmoMagazine = "Energy",
            AmmoRound = "MA_Ion_1",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 1000,
                FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
                Smarts = new SmartsDef
                {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "IonParticle", //EnergyBall
                        ShrinkByDistance = false,
                        Color = Color(red: 1, green: 1, blue: 15, alpha: 0.8f),
                        Offset = Vector(x: 0, y: -1, z: 2),
                        Extras = new ParticleOptionDef
                        {
                            Loop = true,
                            Restart = false,
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "MA_damage_electric", //MA_damage_electric
                        ApplyToShield = true,
                        ShrinkByDistance = false,
              ...
              Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 1f,
                        Color = Color(red: 1, green: 2, blue: 3f, alpha: .9f),
