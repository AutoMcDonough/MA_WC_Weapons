namespace WeaponThread
{
    partial class Weapons
    {
        internal Weapons()
        {
            ...
            ConfigFiles(MA_PDX, MA_Gimbal_Laser, MA_Gimbal_Laser_small, MA_Gladius, MA_Gladius_Ion, MA_PDT, Meatball_Center, Meatball_Left, Meatball_Right, MA_Blister, MA_Fixed_Laser, MA_Fixed_Laser_small, MA_Tiger, MA_Tiger_30_sm);
        }
    }
}
